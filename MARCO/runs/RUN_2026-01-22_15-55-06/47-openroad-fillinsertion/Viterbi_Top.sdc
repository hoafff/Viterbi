...
set_input_delay 20.0000 -clock [get_clocks {clk}] -add_delay [get_ports {received[0]}]
set_input_delay 20.0000 -clock [get_clocks {clk}] -add_delay [get_ports {received[1]}]
