module Survivor_Memory_Unit (clk,
 ...
 sky130_fd_sc_hd__and2_1 _041_ (.A(\Output_Select_Inst.decode_path_01[1] ),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _047_ (.A(\Output_Select_Inst.decode_path_01[1] ),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _053_ (.A(net17),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__and2_1 _054_ (.A(\Output_Select_Inst.decode_path_01[1] ),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _064_ (.A_N(net18),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__or3_1 _065_ (.A(\Output_Select_Inst.decode_path_00[4] ),
    .B(net18),
    .C(net16),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o41a_1 _071_ (.A1(_021_),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__or3_1 _072_ (.A(\Output_Select_Inst.decode_path_00[6] ),
    .B(net18),
    .C(net16),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _103_ (.CLK(clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _104_ (.CLK(clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _105_ (.CLK(clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _106_ (.CLK(clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _107_ (.CLK(clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _109_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net8));
 sky130_fd_sc_hd__dfrtp_1 _110_ (.CLK(clk),
    .D(_001_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout24 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__conb_1 _102__25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net25));
