...
module Branch_Metrics(received, bm_00_00, bm_00_10, bm_01_00, bm_01_10, bm_10_01, bm_10_11, bm_11_01, bm_11_11);
  output [1:0] bm_00_00;
  wire [1:0] bm_00_00;
  output [1:0] bm_00_10;
  wire [1:0] bm_00_10;
  ...
  sky130_fd_sc_hd__nor2_2 _01_ (
    .A(received[0]),
    .B(received[1]),
    .Y(bm_00_10[1])
  );
  sky130_fd_sc_hd__xor2_2 _02_ (
    .A(received[0]),
    .B(received[1]),
    .X(bm_00_00[0])
  );
  sky130_fd_sc_hd__xnor2_2 _03_ (
    .A(received[0]),
    .B(received[1]),
    .Y(bm_10_01[0])
  );
  sky130_fd_sc_hd__and2b_2 _04_ (
    .A_N(received[0]),
    .B(received[1]),
    .X(bm_10_11[1])
  );
  sky130_fd_sc_hd__and2b_2 _05_ (
    .A_N(received[1]),
    .B(received[0]),
    .X(bm_10_01[1])
  );
