module Path_Metric_Unit (clk,
 ...
 sky130_fd_sc_hd__o211a_1 _287_ (.A1(_110_),
    ...
    .C1(_105_),
    .X(_015_));
 sky130_fd_sc_hd__dfrtp_4 _288_ (.CLK(clk),
    .D(_004_),
    .RESET_B(net44),
    .Q(net23));
 sky130_fd_sc_hd__dfrtp_4 _289_ (.CLK(clk),
    .D(_005_),
    .RESET_B(net44),
    .Q(net24));
 sky130_fd_sc_hd__dfrtp_4 _290_ (.CLK(clk),
    .D(_006_),
    .RESET_B(net44),
    .Q(net25));
 sky130_fd_sc_hd__dfrtp_1 _291_ (.CLK(clk),
    ...
    .RESET_B(net45),
    .Q(net26));
 sky130_fd_sc_hd__dfrtp_4 _292_ (.CLK(clk),
    .D(_008_),
    .RESET_B(net45),
    .Q(net27));
 sky130_fd_sc_hd__dfrtp_2 _293_ (.CLK(clk),
    ...
    .RESET_B(net44),
    .Q(net28));
 sky130_fd_sc_hd__dfrtp_4 _294_ (.CLK(clk),
    .D(_010_),
    .RESET_B(net44),
    .Q(net29));
 ...
 sky130_fd_sc_hd__dfrtp_2 _297_ (.CLK(clk),
    ...
    .RESET_B(net44),
    .Q(net20));
 sky130_fd_sc_hd__dfrtp_4 _298_ (.CLK(clk),
    .D(_002_),
    .RESET_B(net44),
    .Q(net21));
 sky130_fd_sc_hd__dfrtp_1 _299_ (.CLK(clk),
    ...
    .RESET_B(net44),
    .Q(net22));
 sky130_fd_sc_hd__dfrtp_4 _300_ (.CLK(clk),
    .D(_012_),
    .RESET_B(net45),
    .Q(net31));
 sky130_fd_sc_hd__dfrtp_4 _301_ (.CLK(clk),
    .D(_013_),
    .RESET_B(net45),
    .Q(net32));
 sky130_fd_sc_hd__dfrtp_4 _302_ (.CLK(clk),
    .D(_014_),
    .RESET_B(net45),
    .Q(net33));
